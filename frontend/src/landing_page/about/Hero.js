    ...
    return ( 
        <div className="container">
            ...
            <div className="row p-5 mt-5 border-top">
                <div className="col-6 p-5 text-muted" style={{lineHeight:"1.8",fontSize:"1.2em"}}>
                ...
                <div className="col-6 p-5 text-muted" style={{lineHeight:"2",fontSize:"1.2em"}}>
                    <p>In addition, we run a number of popular open online educational and community initiatives to empower retail traders and investors.</p>

                    <p> <a href="" className='text-primary' style={{textDecoration:"none"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
